...
variables, we don't optimize variables, we simplify a graph. We don't really have
loops either, just control-flow edges. But this is more or less what we end up with
