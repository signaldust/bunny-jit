...
also merge (FIXME: Do we theoretically need a check for a post-dominator? Not sure
if this is a practical issue though, because it's safe either way and if we enable
further optimizations the movement is probably worth it either way).
